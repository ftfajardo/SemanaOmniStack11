...
export default function Detail(){
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar no caso ${incident.title} com o valor de ${incident.value} reais`
        ...
        <View style={styles.container}>
            ...
            <Image source={logoImgs} />
                <TouchableOpacity>
                    ...
                    color = "#e02041" onPress = {navigateBack} />
                </TouchableOpacity>
            </View>
